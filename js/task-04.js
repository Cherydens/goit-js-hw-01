...
const orderQuantity = prompt('Какое количество дроидов Вы хотите купить?');

const totalPrice = orderQuantity * pricePerDroid;
...
if (orderQuantity === null) {
  ...
  credits -= totalPrice;
  console.log(
    `Вы купили ${orderQuantity} дроидов, на счету осталось ${credits} кредитов.`
  );
}
